 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emfcloud.metamodel.CMMN.impl.EventListenerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventListenerImpl extends PlanItemDefinitionImpl implements EventListener {
	...
	protected EClass eStaticClass() {
		return CMMNPackage.Literals.EVENT_LISTENER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.EVENT_LISTENER__NAME, oldName, name));
	}
