...
public class CMMNAdapterFactory extends AdapterFactoryImpl {
	...
	protected CMMNSwitch<Adapter> modelSwitch =
		new CMMNSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMandatoryDecorator(MandatoryDecorator object) {
				return createMandatoryDecoratorAdapter();
			}
			@Override
			public Adapter caseHTTPHookDecorator(HTTPHookDecorator object) {
				return createHTTPHookDecoratorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emfcloud.metamodel.CMMN.MandatoryDecorator <em>Mandatory Decorator</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emfcloud.metamodel.CMMN.HTTPHookDecorator <em>HTTP Hook Decorator</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
