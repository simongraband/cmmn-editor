...
/**
 * This is the item provider adapter for a {@link org.eclipse.emfcloud.metamodel.CMMN.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends PlanItemDefinitionItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTaskRolePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_taskType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_taskType_feature", "_UI_Task_type"),
				 CMMNPackage.Literals.TASK__TASK_TYPE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Task Role feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTaskRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_taskRole_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_taskRole_feature", "_UI_Task_type"),
				 CMMNPackage.Literals.TASK__TASK_ROLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CMMNPackage.Literals.TASK__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
