...
/**
 * This is the item provider adapter for a {@link org.eclipse.emfcloud.metamodel.CMMN.Stage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StageItemProvider extends PlanItemDefinitionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CMMNPackage.Literals.STAGE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CMMNPackage.Literals.STAGE__TASKS);
			childrenFeatures.add(CMMNPackage.Literals.STAGE__EVENT_LISTENERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CMMNPackage.Literals.STAGE__TASKS,
				 CMMNFactory.eINSTANCE.createTask()));

		newChildDescriptors.add
			(createChildParameter
				(CMMNPackage.Literals.STAGE__EVENT_LISTENERS,
