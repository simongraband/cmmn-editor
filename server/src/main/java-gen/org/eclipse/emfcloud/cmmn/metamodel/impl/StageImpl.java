 ...
 * </p>
 * <ul>
 *   <li>{@link metamodel.impl.StageImpl#getTasks <em>Tasks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StageImpl extends PlanItemDefinitionImpl implements Stage {
	...
	public EList getTasks() {
		if (tasks == null) {
			tasks = new EObjectContainmentEList(Task.class, this, MetamodelPackage.STAGE__TASKS);
		}
		return tasks;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MetamodelPackage.STAGE__TASKS:
