...
public class ExpressionImpl extends CMMNElementImpl implements Expression {
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.EXPRESSION__LANGUAGE, oldLanguage, language));
	}
	...
	public void setBody(String newBody) {
		...
		body = newBody;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.EXPRESSION__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetamodelPackage.EXPRESSION__LANGUAGE:
				return getLanguage();
			case MetamodelPackage.EXPRESSION__BODY:
				return getBody();
		}
